...
-- Date: 9/9/2025
-- Description: alter the table created to track updates with a modified by user 
-- and modified date to create version tracking as data is modified over time 
